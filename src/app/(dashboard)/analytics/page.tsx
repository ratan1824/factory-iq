...
import { Download, Filter, Calendar, Share2 } from "lucide-react";
    ...
    <div className="space-y-8 animate-in slide-in-from-bottom-2 duration-500">
      <div className="flex items-end justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button className="bg-primary text-white"><Download className="mr-2 h-4 w-4" /> Export Report</Button>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                 <Button variant="ghost" className="w-full justify-start text-sm">Monthly Production Yield</Button>
                 <Button variant="ghost" className="w-full justify-start text-sm">Quarterly Quality Audit</Button>
                 <Button variant="ghost" className="w-full justify-start text-sm">Vendor Scorecard 2023</Button>
              </div>
            </div>
            <div className="space-y-4">
