...
import { ClipboardCheck, FileText, Activity, ShieldCheck, Plus } from "lucide-react";
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Part / Module</TableHead>
            ...
            <TableBody>
              {QUALITY_REPORTS.map((report) => (
                <TableRow key={report.id}>
                  ...
                  <TableCell className="font-medium">{report.part}</TableCell>
                  <TableCell>{report.issue}</TableCell>
                  <TableCell className="text-muted-foreground text-xs">{report.date}</TableCell>
                  <TableCell>
                    <Badge variant={report.status === 'Closed' ? 'outline' : 'secondary'}>
                      {report.status}
                    </Badge>
                  </TableCell>
